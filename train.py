...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: dict):
    ...
    # Match SOLO's AMP statistics and best-checkpoint selection. The rollout
    # memory still receives the raw task reward; only SKRL's tracker sees the
    # effective task + discriminator-style reward.
    if algorithm == "amp" and args_cli.ml_framework.startswith("torch"):
        from jose.skrl_compat import install_amp_reward_tracking
